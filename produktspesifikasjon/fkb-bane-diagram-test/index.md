...
# Produktspesifikasjon: FKB-Bane

*FKB-Bane er en del av Felles Kartdatabase (FKB). FKB er en samling datasett som utgjør en sentral del av grunnkartet. Se metadataoppføring for Felles Kartdatabase for mer info.
...
**Nøkkelord:** FKB, Basiskart, Grunnkart, Jernbane, Tunnelbane, Sporveg, Norge, Nasjonalt, geodataloven, Norge digitalt, beredskapsbase, Det offentlige kartgrunnlaget, fellesDatakatalog, Basis geodata, Bane
...
## Om produktet FKB-Bane


> **Romlig representasjonstype:** Vektor<br>
> **Unik identifikator:** 3165138f-1461-44fe-8b10-eac44e08a10a<br>
> **Kontaktinformasjon:** Geovekst, [kundesenter@kartverket.no](mailto:kundesenter@kartverket.no)
>
> **Romlig oppløsning:**
>
...
### Datamodell for FKB-Bane

**Nivå**: dataset

**Nivåbeskrivelse**: Viser full modell for FKB-Bane 5.0.1

## Datainnhold og struktur



### Datamodell - Datamodell for FKB-Bane



<a href="datamodell-for-fkb-bane/datamodell-for-fkb-bane_feature_catalogue_overview.png" title="Klikk for stor visning"><img src="datamodell-for-fkb-bane/datamodell-for-fkb-bane_feature_catalogue_overview.png" alt="Datamodell Datamodell for FKB-Bane" style="max-width: 100%; height: auto;" /></a>



➡️ [Se full datamodell for omfang "Datamodell for FKB-Bane" (diagram per pakke og objektkatalog)](datamodell-for-fkb-bane/objektkatalog.html)
...
- **Kvalitetsmål**: SOSI-produktspesifikasjon: FKB Bane
...
| Atom Feed | [Lenke](http://nedlasting.geonorge.no/geonorge/ATOM-feeds/FKB-Bane_AtomFeedFGDB.xml) | W3C:AtomFeed | FGDB | fylkesvis, kommunevis, landsfiler |
| Atom Feed | [Lenke](http://nedlasting.geonorge.no/geonorge/ATOM-feeds/FKB-Bane_AtomFeedGML.xml) | W3C:AtomFeed | GML | fylkesvis, kommunevis, landsfiler |
| Atom Feed | [Lenke](http://nedlasting.geonorge.no/geonorge/ATOM-feeds/FKB-Bane_AtomFeedSOSI.xml) | W3C:AtomFeed | SOSI | fylkesvis, kommunevis, landsfiler |
...
- **Utsteder**: Geonorge
- **kode**: 3165138f-1461-44fe-8b10-eac44e08a10a
- **koderom**: <https://kartkatalog.geonorge.no/metadata/>
- **Metadatalenke**: <https://kartkatalog.geonorge.no/metadata/3165138f-1461-44fe-8b10-eac44e08a10a>
